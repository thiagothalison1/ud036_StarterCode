...
class MoviesList:
    ...
    def register_movie(self, title, description, poster_img_url, trailer_url, imdb_page_url):
        ...
        """
        movie = Movie(title, description, poster_img_url, trailer_url, imdb_page_url)
